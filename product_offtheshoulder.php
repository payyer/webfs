    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="img/k7.jpg" width="100%" id="MainImg" alt="">
            ...
            <div class="single-pro-details">
                ...
                <button onclick="addToCart(9, 1)">Add to cart   </button>
                <script src="addtocart.js"></script>
                <h4>Product details</h4>
                <span>
                    Chiếc áo dú siêu mỏng huyền bí khiến mọi đam mê trong bạn trở nên thăng hoa
                </span>
            </div>
        </section>
        ...
        <section id='spham' class='section-p1'>
            ...
            <div class="pro-container">
               ...
               <div class="pro" onclick="window.location.href='product_camisoleorange.php'">
                ...
                <div class="pro" onclick="window.location.href='product_black3lo.php'">
